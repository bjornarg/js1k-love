var f=c.width=window.innerWidth,g=c.height=window.innerHeight,h=f/2,j=0.4*g,k=0,l=[],m=[];M=Math;C=M.cos;S=M.sin;P=M.PI;function n(b){return{x:f/6*M.pow(S(b),3),y:g/-60*(15*C(b)-5*C(2*b)-2*C(3*b)-C(4*b)),a:0}}function o(b){return M.floor(M.random()*b)}function q(){var b=l[L].d;return{x:b.x,y:b.y,a:b.a,e:l[L].b,c:"hsl("+o(361)+","+o(101)+"%,"+o(50)+"%)"}}for(var r=-P/2;r<P/2;r+=0.01*P)(-0.25>r||0.25<r)&&l.push({d:n(r),b:n(r+P)});
